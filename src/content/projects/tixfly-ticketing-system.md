---
featured: true
title: Tixfly (Ticketing System)
description: >-
  Tixfly is an Indonesian-based event management and ticketing platform designed
  to be a "360-degree ecosystem" for event organizers.
image: '@assets/projects/tixfly-ticketing-system/image.png'
...
- Developed a sales and settlement report used for financial reconciliation
- Aggregated transaction data into structured reports for finance processing
- Prepared export-ready reports to support settlement by the finance team
- Implemented automated delivery of settlement reports at scheduled times
- Ensured data accuracy and consistency across reporting periods
- Built the feature to handle large transaction volumes efficiently
